...
<body>
    ...
    <!-- tabla -->
    <div class="container d-flex justify-content-between" style="margin: auto; text-align: center; max-width: 960px;">
        <div class="card" id="tabla">
            <div class="card-header" id="card1">
                Egresos y Categoria
            </div>
            <ul class="list-group list-group-flush">
                <?php include("../src/INFO_EGRESOS.php"); ?>
            </ul>
        </div>
        ...
        <div class="card" id="tabla2">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item" id="cuentas"> $ <?php echo number_format($totalEgresos, 2); ?></li>
            </ul>
        </div>
    </div>
